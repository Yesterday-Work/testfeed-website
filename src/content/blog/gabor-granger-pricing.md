---
title: "Gabor-Granger Pricing: The Complete Guide | TestFeed"
description: "Learn how Gabor-Granger pricing works, when to use it, and how it compares to Van Westendorp. A practical guide for brand managers and pricing strategists."
articleTitle: "Gabor-Granger Pricing: The Complete Method Guide"
author: "Millie Marconi"
publishDate: 2026-06-04
updatedDate: 2026-06-04
minutesRead: 9
tags: ["pricing research", "market research", "brand research"]
excerpt: "Gabor-Granger pricing is one of the most widely used survey methods for measuring willingness to pay and identifying revenue-optimising price points. This guide explains how it works, when to use it, and how it compares to the Van Westendorp model."
relatedPosts: ["test-audience"]
keyTakeaways:
  - "Gabor-Granger pricing works by presenting respondents with sequential price points and asking whether they would purchase at each price, producing a demand curve and a revenue-maximising price."
  - "It is best suited to existing products or line extensions where a plausible price range is already known, rather than entirely new concepts entering a market."
  - "Van Westendorp identifies acceptable price boundaries; Gabor-Granger finds the specific price within that range that maximises revenue. Many studies benefit from running both."
authorBio:
...
faq:
  - question: "What is the Gabor-Granger pricing method?"
    answer: "Gabor-Granger pricing is a survey-based technique that measures price elasticity by presenting respondents with a series of price points and asking whether they would purchase at each one. Results are used to build a demand curve and identify the price that maximises expected revenue."
  - question: "How many price points should a Gabor-Granger study include?"
    answer: "Most practitioners recommend between 5 and 15 price points. Too few price points produce a coarse demand curve with limited resolution; too many can fatigue respondents. A set of 6 to 10 evenly spaced or strategically chosen prices typically gives sufficient granularity."
  - question: "What sample size do I need for a Gabor-Granger study?"
    answer: "A minimum of 100 completed responses is the general rule for a single segment. If you need to compare sub-groups, such as heavy vs. light users or different channels, aim for at least 100 responses per segment to ensure statistically reliable differences."
  - question: "What is the difference between Gabor-Granger and Van Westendorp?"
    answer: "Van Westendorp uses four open-ended price questions to map the range consumers find acceptable. Gabor-Granger tests specific predefined prices to find the revenue-optimal point within a range. Van Westendorp is better for exploring an unfamiliar market; Gabor-Granger is better when you already know the plausible range and need to pinpoint the best price."
schemaMarkup:
  type: "BlogPosting"
  properties:
    datePublished: "2026-06-04"
    dateModified: "2026-06-04"
    image: "https://testfeed.ai/assets/blog/gabor-granger-pricing/cover.webp"
    mainEntityOfPage: "https://testfeed.ai/blog/gabor-granger-pricing/"
finalCtaSection:
  title: "Run Gabor-Granger pricing research without the wait"
  text: "TestFeed's synthetic audience platform lets you test price points against AI-simulated respondents in minutes, giving you demand curves and revenue estimates before you spend a pound on fieldwork."
draft: true
---
...
3. At what price would this product be getting expensive, but you might still consider it?
...
For a deeper look at how synthetic audiences can speed up both types of study, see our guide on [how to test audience assumptions before fieldwork](/blog/test-audience/).
...
**You need results quickly.** Gabor-Granger surveys are short, easy to programme on most platforms, and straightforward to analyse. For teams working to compressed timelines, a well-scoped Gabor-Granger study can move from brief to insight in days rather than weeks.
...
Some practitioners use a 5- or 7-point purchase intent scale instead of a binary yes/no question. This is acceptable, but you must decide before analysis which scale points count as "would buy." A common convention is to count only the top 2 boxes (definitely would buy and probably would buy at a reduced weight). Apply this rule consistently or your demand curve will not be comparable across studies.
...
A minimum of 100 completed responses per segment is the standard rule. If you need to compare sub-groups, such as heavy vs. light users or different geographies, plan for at least 100 responses per sub-group.
...
The challenge, as with all survey-based pricing methods, is the gap between what people say they will do and what they actually do when their own money is on the line. Minimising that gap requires rigorous sampling, careful questionnaire design, and honest calibration of stated intent. For teams that want to move faster without sacrificing rigour, synthetic audience research offers a way to run Gabor-Granger analysis against AI-simulated respondents before committing to full fieldwork, allowing you to stress-test your price range and question design before a single real respondent is recruited.

To understand how synthetic audiences can complement traditional pricing surveys, read our guide on [testing your audience assumptions](/blog/test-audience/).
